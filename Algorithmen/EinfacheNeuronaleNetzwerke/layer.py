...
class Layer:
    def __init__(self, previous_layer: Optional[Layer], num_neurons: int, learning_rate: float,
        ...
        # Das Folgende könnte alles eine große List Comprehension sein, würde aber etwas zu lang
    ...
    # Sollte nur für eine Ausgabeschicht aufgerufen werden
    ...
    # Sollte nicht für eine Ausgabeschicht aufgerufen werden
