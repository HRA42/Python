...
if __name__ == "__main__":
    ...
    with open('wine.csv', mode='r') as wine_file:
        ...
        shuffle(wines) # Datenzeilen in eine zuf�llige Reihenfolge bringen
        for wine in wines:
    ...
    # 10-mal mit den ersten 150 Weinen trainieren
    ...
    # Mit den letzten 28 Weinen im Datensatz testen
    ...
    print(f"{wine_results[0]} korrekt von {wine_results[1]} = {wine_results[2] * 100}%")
